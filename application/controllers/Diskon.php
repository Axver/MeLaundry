...
class Diskon extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('diskon/diskon_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'jumlah_diskon' => $row->jumlah_diskon,
            ...
            $this->load->view('diskon/diskon_read', $data);
        } else {
    ...
    public function create() 
    {
	    ...
	    'jumlah_diskon' => set_value('jumlah_diskon'),
	);
        $this->load->view('diskon/diskon_form', $data);
    }
    ...
    public function update($id) 
    {
		...
		'jumlah_diskon' => set_value('jumlah_diskon', $row->jumlah_diskon),
	    );
            $this->load->view('diskon/diskon_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
    ...
    {
	$this->form_validation->set_rules('jumlah_diskon', 'jumlah diskon', 'trim|required');
