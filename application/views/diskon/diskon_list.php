...
<section class="content">
        ...
        <h2 style="margin-top:0px">Diskon List</h2>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('diskon/read/'.$diskon->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('diskon/update/'.$diskon->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('diskon/delete/'.$diskon->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
